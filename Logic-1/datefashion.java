/*
  ...
  an int value with 0=no, 1=maybe, 2=yes. If either of you is very stylish, 8 or more, then the result is 2. With the 
  exception that if either of you has style of 2 or less, then the result is 0 (no). Otherwise the result is 1.
